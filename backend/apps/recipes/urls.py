...
from .views import (
    ...
    MealPlanViewSet, ShoppingListViewSet, ChallengeViewSet,
    ChallengeEntryViewSet, RecipeVoteViewSet
)
...
router.register(r'challenge-entries', ChallengeEntryViewSet, basename='challengeentry')
router.register(r'challenge-votes', RecipeVoteViewSet, basename='recipevote')
